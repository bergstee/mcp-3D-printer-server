 ...
 */
function getErrorCode(attr, code) {
    return (attr.toString(16).padStart(8, "0") + code.toString(16).padStart(8, "0"));
}
/**
...
function getErrorMessage(code) {
    var _a;
    return (_a = exports.errorCodes[code]) !== null && _a !== void 0 ? _a : "Unknown error.";
}
exports.errorCodes = {
    ...
    "0C00030000020010": "Foreign objects detected on hotbed: please check and clean the hotbed.",
    ...
    "03000D0000020004": "The build plate is not placed properly. Please adjust it.",
    "03000D0000020005": "The build plate is not placed properly. Please adjust it.",
    "03000D0000020006": "The build plate is not placed properly. Please adjust it.",
    "03000D0000020007": "The build plate is not placed properly. Please adjust it.",
    "03000D0000020008": "The build plate is not placed properly. Please adjust it.",
    "03000D0000020009": "The build plate is not placed properly. Please adjust it.",
    "03000D000002000A": "The build plate is not placed properly. Please adjust it.",
    "03000D0000020003": "The build plate is not placed properly. Please adjust it.",
    ...
    "03001D0000010001": "The position sensor of extrusion motor is abnormal. The sensor signal wire may be not properly plugged in.",
    "03001C0000010001": "The extrusion motor driver is abnormal. The MOSFET may have a short circuit.",
    "030001000001000A": "The hotbed temperature control is abnormal, the AC board may be broken.",
    ...
    "0300170000010001": "The speed of the nozzle fan is too slow or stopped. It may be stuck or the connector may not be plugged in properly.",
    "0300170000020002": "The speed of the nozzle fan is slow. It may be stuck and need cleaning.",
    ...
    "1200200000020006": "Failed to extrude AMS1 Slot1 filament; the extruder may be clogged or the filament may be too thin, causing the extruder to slip.",
    "1201200000020006": "Failed to extrude AMS2 Slot1 filament; the extruder may be clogged or the filament may be too thin, causing the extruder to slip.",
    "1202200000020006": "Failed to extrude AMS3 Slot1 filament; the extruder may be clogged or the filament may be too thin, causing the extruder to slip.",
    "1203200000020006": "Failed to extrude AMS4 Slot1 filament; the extruder may be clogged or the filament may be too thin, causing the extruder to slip.",
    "1200210000020006": "Failed to extrude AMS1 Slot2 filament; the extruder may be clogged or the filament may be too thin, causing the extruder to slip.",
    "1201210000020006": "Failed to extrude AMS2 Slot2 filament; the extruder may be clogged or the filament may be too thin, causing the extruder to slip.",
    "1202210000020006": "Failed to extrude AMS3 Slot2 filament; the extruder may be clogged or the filament may be too thin, causing the extruder to slip.",
    "1203210000020006": "Failed to extrude AMS4 Slot2 filament; the extruder may be clogged or the filament may be too thin, causing the extruder to slip.",
    "1200220000020006": "Failed to extrude AMS1 Slot3 filament; the extruder may be clogged or the filament may be too thin, causing the extruder to slip.",
    "1201220000020006": "Failed to extrude AMS2 Slot3 filament; the extruder may be clogged or the filament may be too thin, causing the extruder to slip.",
    "1202220000020006": "Failed to extrude AMS3 Slot3 filament; the extruder may be clogged or the filament may be too thin, causing the extruder to slip.",
    "1203220000020006": "Failed to extrude AMS4 Slot3 filament; the extruder may be clogged or the filament may be too thin, causing the extruder to slip.",
    "1200230000020006": "Failed to extrude AMS1 Slot4 filament; the extruder may be clogged or the filament may be too thin, causing the extruder to slip.",
    "1201230000020006": "Failed to extrude AMS2 Slot4 filament; the extruder may be clogged or the filament may be too thin, causing the extruder to slip.",
    "1202230000020006": "Failed to extrude AMS3 Slot4 filament; the extruder may be clogged or the filament may be too thin, causing the extruder to slip.",
    "1203230000020006": "Failed to extrude AMS4 Slot4 filament; the extruder may be clogged or the filament may be too thin, causing the extruder to slip.",
    ...
    "0300940000030001": "Chamber cooling may be too slow. You can open the chamber to help cooling if the gas in chamber is non-toxic.",
    ...
    "0500030000010023": "The CTC module is malfunctioning. Please restart the device.",
